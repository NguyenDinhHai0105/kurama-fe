export default function Feature({ icon, title, children, backgroundImg, meta }) {
  // If we have a background image (from API), render a richer “story” card
  if (backgroundImg) {
    return (
      <article className="feature feature--story">
        <div className="feature-body">
          {meta && (
            <p className="feature-meta">
              ...
              {meta.sourceHref ? (
                <a className="feature-source" href={meta.sourceHref} target="_blank" rel="noreferrer">
                  {meta.sourceText}
                </a>
              ) : (
